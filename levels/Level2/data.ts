...
export const quizQuestions: QuizQuestion[] = [
  {
    id: 'L2Q1',
    text: '裂縫的兩個內角分別是 50° 和 70°，對面那側量不到的外角是多少度？',
  ...
  {
    id: 'L2Q2',
    text: '另一道裂縫，外面的角量到 140°，其中一個內角是 60°，另一個量不到的內角是？',
    options: ['80°', '70°', '90°', '60°'],
    correctIndex: 0,
  ...
  {
    id: 'L2Q3',
    text: '外角有可能比三角形裡面最大的內角還小嗎？',
    options: ['有可能', '不可能'],
    correctIndex: 1,
    explanation: '外角 = 兩個內角的和，一定比其中任何一個大。',
  },
  {
    id: 'L2Q4',
    text: '某一道裂縫的「外角」是 90°，其中一個「內角」是 30°，這個三角形的三個內角分別是？',
    options: ['30°、60°、90°', '30°、90°、60°', '30°、45°、105°', '30°、60°、80°'],
    correctIndex: 0,
