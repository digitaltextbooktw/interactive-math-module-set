...
export const quizQuestions: QuizQuestion[] = [
  {
    id: 'L1Q1',
    text: '一個三角形的三個角分別是 50°、60°、70°，這是合理的三角形嗎？',
    options: ['是，因為 50 + 60 + 70 = 180°', '不是，角度加起來不對'],
    correctIndex: 0,
    explanation: '三個角加起來剛好 180°，符合三角形內角和定理。',
  },
  {
    id: 'L1Q2',
    text: '一個三角形的三個角分別是 40°、80°、70°，這個三角形存在嗎？',
    options: ['可以，角度沒問題', '不行，角度加起來超過 180°', '要再量一次才知道'],
    correctIndex: 1,
    explanation: '40 + 80 + 70 = 190°，超過 180°，這樣的三角形不存在。',
  },
  {
    id: 'L1Q3',
    text: '一個三角形已知兩個角是 35° 和 65°，第三個角是多少？',
